...
export const RecoveryEmail = ({ siteName, confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your password for Monkey Trucking</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          We received a request to reset your password for Monkey Trucking. Click the button below to choose a new password.
        </Text>
