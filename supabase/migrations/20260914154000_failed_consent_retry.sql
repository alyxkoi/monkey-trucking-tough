...
-- Provider acceptance is not delivery. A confirmed terminal delivery failure
-- may be followed by a new staff-requested opt-in; pending/ambiguous requests
-- still block duplicates. Preserve the original message and outbox evidence.
