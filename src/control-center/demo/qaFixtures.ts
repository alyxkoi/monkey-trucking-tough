...
function customer(
  ...
  return {
    ...
    sms_double_opt_in_at: createdAt,
...
export function createQaFixtureData(reference = new Date()): ControlData {
  ...
  const materials = [
    { id: 'qa-material-crushed', name: 'Commercial Crushed Concrete Clean', price_per_yard: 20, full_load_price: 350, full_load_yards: 20, tons_per_cubic_yard: 1.4, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 1, created_at: at(-500), updated_at: at(-30) },
    { id: 'qa-material-cushion', name: 'Select Fill and Cushion Sand', price_per_yard: 20, full_load_price: 350, full_load_yards: 20, tons_per_cubic_yard: 1.35, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 2, created_at: at(-500), updated_at: at(-30) },
    { id: 'qa-material-3x4', name: '3x4 Crushed Concrete', price_per_yard: 35, full_load_price: 700, full_load_yards: 20, tons_per_cubic_yard: 1.35, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 3, created_at: at(-500), updated_at: at(-30) },
    { id: QA_MISSING_DELIVERY_MATERIAL_ID, name: 'Flexbase First Class 1" or 3"', price_per_yard: 38, full_load_price: 720, full_load_yards: 20, tons_per_cubic_yard: 1.4, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 4, created_at: at(-500), updated_at: at(-30) },
    { id: 'qa-material-mason', name: 'Mason Sand', price_per_yard: 45, full_load_price: 820, full_load_yards: 20, tons_per_cubic_yard: 1.35, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 5, created_at: at(-500), updated_at: at(-30) },
    { id: 'qa-material-millings', name: 'Millings Asphalt 1/2" Minus', price_per_yard: 45, full_load_price: 840, full_load_yards: 20, tons_per_cubic_yard: 1.25, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 6, created_at: at(-500), updated_at: at(-30) },
    { id: 'qa-material-gravel', name: 'Native Gravel 3/8"-1"', price_per_yard: 53, full_load_price: 980, full_load_yards: 20, tons_per_cubic_yard: 1.35, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 7, created_at: at(-500), updated_at: at(-30) },
    { id: 'qa-material-concrete-sand', name: 'Concrete Sand Mix Native Gravel', price_per_yard: 55, full_load_price: 1040, full_load_yards: 20, tons_per_cubic_yard: 1.4, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 8, created_at: at(-500), updated_at: at(-30) },
    { id: 'qa-material-granite', name: 'Decomposed Granite', price_per_yard: 65, full_load_price: 1200, full_load_yards: 20, tons_per_cubic_yard: 1.35, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 9, created_at: at(-500), updated_at: at(-30) },
    { id: 'qa-material-limestone', name: 'Limestone 1"-1 1/2"', price_per_yard: 95, full_load_price: 1700, full_load_yards: 20, tons_per_cubic_yard: 1.4, tons_conversion_basis: 'OPERATIONAL_ESTIMATE', tons_conversion_verified: false, tons_conversion_note: 'QA estimate', is_active: true, sort_order: 10, created_at: at(-500), updated_at: at(-30) },
  ].map((material,index)=>({...material,catalog_key:`mat-${index+1}`}))

  const tickets: ControlData['tickets'] = [
    { id: 'qa-ticket-mixed', ticket_number: 'MT1108', client_request_id: '10000000-0000-4000-8000-000000000108', customer_id: 'qa-customer-kaufman-feed', job_id: 'qa-job-kaufman-history', customer_name: 'Kaufman Feed', customer_phone: '(972) 555-0119', job_site_address: '400 S Washington, Kaufman', driver_id: 'qa-driver-salvador', delivery_type: 'tier_2', delivery_miles: null, delivery_fee_per_load: 60, load_count: 5, delivery_total: 300, materials_subtotal: 2860, tax_rate: 8.25, tax_applies_to_delivery: true, tax_amount: 260.7, grand_total: 3420.7, notes: '3 Flexbase loads and 2 Crushed Concrete loads.', payment_status: 'paid', status: 'saved', printed_at: at(-12, 19), voided_at: null, void_reason: null, voided_by: null, created_by: QA_FIXTURE_USER_ID, created_at: at(-12, 17), updated_at: at(-12, 19) },
    { id: 'qa-ticket-standalone', ticket_number: 'MT1109', client_request_id: '10000000-0000-4000-8000-000000000109', customer_id: QA_MISSING_DELIVERY_CUSTOMER_ID, job_id: null, customer_name: 'Arturo Martinez', customer_phone: '(972) 555-0182', job_site_address: '2290 County Road 4104, Kaufman', driver_id: 'qa-driver-salvador', delivery_type: 'tier_2', delivery_miles: null, delivery_fee_per_load: 60, load_count: 1, delivery_total: 60, materials_subtotal: 720, tax_rate: 8.25, tax_applies_to_delivery: true, tax_amount: 64.35, grand_total: 844.35, notes: 'Standalone direct material order.', payment_status: 'unpaid', status: 'saved', printed_at: null, voided_at: null, void_reason: null, voided_by: null, created_by: QA_FIXTURE_USER_ID, created_at: at(-4), updated_at: at(-4) },
    { id: 'qa-ticket-offline', ticket_number: '', client_request_id: '10000000-0000-4000-8000-000000000110', customer_id: 'qa-customer-lopez', job_id: 'qa-job-material-today', customer_name: 'Lopez Materials', customer_phone: '(469) 555-0160', job_site_address: '1700 SH 34, Terrell', driver_id: 'qa-driver-salvador', delivery_type: 'tier_3', delivery_miles: null, delivery_fee_per_load: 100, load_count: 1, delivery_total: 100, materials_subtotal: 350, tax_rate: 8.25, tax_applies_to_delivery: true, tax_amount: 37.13, grand_total: 487.13, notes: 'Offline QA ticket waiting to sync.', payment_status: 'unpaid', status: 'pending', printed_at: null, voided_at: null, void_reason: null, voided_by: null, created_by: QA_FIXTURE_USER_ID, created_at: at(0, 6, 45), updated_at: at(0, 6, 45) },
    { id: 'qa-ticket-void', ticket_number: 'MT1107', client_request_id: '10000000-0000-4000-8000-000000000107', customer_id: 'qa-customer-riverbend', job_id: null, customer_name: 'Riverbend Estates', customer_phone: '(469) 555-0190', job_site_address: '501 River Bend Road, Terrell', driver_id: 'qa-driver-salvador', delivery_type: 'tier_2', delivery_miles: null, delivery_fee_per_load: 60, load_count: 1, delivery_total: 60, materials_subtotal: 350, tax_rate: 8.25, tax_applies_to_delivery: true, tax_amount: 33.83, grand_total: 443.83, notes: null, payment_status: 'unpaid', status: 'void', printed_at: null, voided_at: at(-6), void_reason: 'Customer cancelled before material left the yard', voided_by: QA_FIXTURE_USER_ID, created_by: QA_FIXTURE_USER_ID, created_at: at(-7), updated_at: at(-6) },
  ]
  ...
  const automations: AutomationRule[] = [
    ...
    { id: 'review-request', name: 'Review request', trigger_description: 'Completed job and paid invoice', conditions: ['No complaint', 'Not already sent'], delay_description: 'Immediately after full confirmed payment', action_description: 'Outcome appreciation then review request', stop_conditions: ['Problem reported', 'Already sent'], fallback_description: 'Problem goes to Salvador', log_description: 'Job and customer history', status: 'SETUP_REQUIRED', updated_at: at(-1) },
  ]
