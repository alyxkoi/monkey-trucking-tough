...
function DemoControls({ value }: { value: DemoModeValue }) {
  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-24 left-3 z-[100] flex h-11 w-11 items-center justify-center rounded-full border border-ice/30 bg-[#111116]/90 text-ice opacity-70 shadow-lifted backdrop-blur-xl transition-[border-color,opacity] hover:border-ice/60 hover:opacity-100 lg:bottom-4 lg:left-[264px]"
      >
  ...
  return (
    <aside className="fixed bottom-24 left-3 z-[100] w-[min(310px,calc(100vw-24px))] rounded-2xl border border-ice/30 bg-[#111116]/94 p-3 shadow-lifted backdrop-blur-xl lg:bottom-4 lg:left-[264px]">
