...
/**
 * Things that must be settled before the system goes live.
 * These are internal. None of this language ever appears on a customer facing
 * quote, invoice or message.
 */
...
export const PRELAUNCH_BLOCKERS: PrelaunchItem[] = [
  {
    id: 'custom-work-tax',
    label: 'Custom work tax treatment',
    detail:
      'The ticket system only defines tax on material and delivery. Service work is excluded from the taxable base until the bookkeeper confirms how it should be treated.',
    where: 'Business',
    to: '/admin/settings/business',
  },
  {
    id: 'business-contact',
    label: 'Business phone and email',
    detail: 'These print on every ticket and go on every invoice.',
    where: 'Business',
    to: '/admin/settings/business',
  },
  {
    ...
    detail:
      'The label needs a bold, simplified, high contrast bitmap. The detailed logo turns to mud at 203 dpi.',
    where: 'Printing & System',
    to: '/admin/settings/printing',
  },
  {
    id: 'business-number',
    label: 'Business number for SMS and calling',
    detail: 'Every customer automation stays off until this is connected.',
    where: 'Communication & AI',
    to: '/admin/settings/communication',
  },
  {
    id: 'printer',
    label: 'Final printer path',
    detail:
      'The MUNBYN prints 80mm and the label is designed for 4 x 6. The Rollo decides whether printing goes through the share sheet or direct AirPrint.',
    where: 'Printing & System',
    to: '/admin/settings/printing',
  },
]
