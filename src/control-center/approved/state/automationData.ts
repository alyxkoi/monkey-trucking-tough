...
export const AUTOMATIONS: AutomationRule[] = [
  ...
  },
  {
    ...
    conditions: ['Job is not cancelled', 'It was booked more than 24 hours before the work'],
    delay: 'About 24 hours before the job',
    action: 'One reminder with the date and time',
    stopConditions: [
      'Job cancelled',
      'Job completed early',
      'Job rescheduled, the old reminder is cancelled and a new one is set',
    ],
    fallback: 'A requested time change is acknowledged and handed to Salvador, never moved by AI',
    log: 'Reminder state on the job and the customer timeline',
    status: 'SETUP_REQUIRED',
    tunable: true,
  },
  {
