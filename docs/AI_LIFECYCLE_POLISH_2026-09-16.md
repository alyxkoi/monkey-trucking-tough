...
- **The follow-up backend redeployment is pending:** Lovable exhausted its credits before this second deployment. No credits were purchased. Its Cloud function UI exposes no direct deploy control, and no separately authenticated deployment CLI is available. Until redeployed, live v11 can still over-escalate the additional-yard request; expected corrected version is v11.1.
